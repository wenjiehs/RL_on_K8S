#!/usr/bin/env python3
"""
Generate test Parquet files for Data Management testing
"""
...
def main():
  ...
  "created_at": "''' + datetime.now().isoformat() + '''"
    ...
    print(f"\nYou can now browse these files in the Data Management interface.")
    print(f"Base path: {base_path}/{experiment_id}")
